...
const ENTRIES: Entry[] = [
  ...
  // Blog
  { path: '/blog', lastModified: '2026-08-24', changeFrequency: 'weekly', priority: 0.8 },
  { path: '/blog/ai-consulting-westchester', lastModified: '2026-08-24', changeFrequency: 'monthly', priority: 0.7 },
