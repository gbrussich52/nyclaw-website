...
export const metadata: Metadata = {
  ...
  description: 'Why operational processes degrade over time and how to design mission-driven systems that resist entropy — OKR frameworks and review cadences.',
